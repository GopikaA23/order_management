...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference("Buyer.count") do
      post buyers_url, params: { buyer: { country: @buyer.country, currency: @buyer.currency, name: @buyer.name } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { country: @buyer.country, currency: @buyer.currency, name: @buyer.name } }
